...
async function loadApiList() {
  ...
  try {
    apiList.innerHTML =
      '<div class="loading"><i class="fas fa-spinner fa-spin"></i> Loading APIs...</div>';
...
async function editData(id, name) {
  try {
    ...
    document.getElementById('response-path').value =
