...
const AI_CONFIG = {
  ...
  titlePromptTemplate:
    'Suggest an extremely short 2-3 word title for this message: "{message}"',
};
...
const { PROD_DOMAIN } = process.env; // Used in Cookie config
...
const CORS_CONFIG = {
  origin:
    ...
    (NODE_ENV === 'production' ? undefined : 'http://localhost:3000'), // Stricter default in prod
...
module.exports = {
  ...
  chat: {
    ...
    DEFAULT_ROOMS, // Use the constant defined above
    MESSAGES, // Use the constant defined above
    ROOM_MANAGEMENT, // Add room management constants
  },
